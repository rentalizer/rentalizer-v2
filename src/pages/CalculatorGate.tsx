...
const CalculatorGate = () => {
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-6 bg-transparent rounded-lg p-8">
              ...
              <p className="text-xl text-gray-300 mb-6 sm:text-lg">
                Calculate Your Rental Arbitrage Profitability
              </p>
            </div>

            {/* Calculator Preview - Blurred */}
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-slate-800/50 border border-gray-700/50 rounded-lg p-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-white font-semibold">Profit Analysis</h3>
                      <div className="bg-green-500/20 rounded p-4">
                        <div className="text-green-400 text-2xl font-bold">$1,250</div>
                        <div className="text-gray-300 text-sm">Monthly Net Profit</div>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  // For development, show the calculator directly
  return <CalculatorPage />;
};
